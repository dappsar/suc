...
* [proxy/proxy.sol](src/contracts/proxy/proxy.sol): Contrato utilizado para la actualización del contrato [sucToken.sol](src/contracts/principal/sucToken.sol). No se muestra en el diagrama, dado que su uso es a nivel de implementación y no tiene relación directa con el resto de contratos (qedaría como una "caja" suelta en el diagrama).
